...
public class testyBZ implements AutoCloseable {

    private static final Logger LOGGER = Logger.getLogger(testyBZ.class.getName());

    private final Driver driver;

    public testyBZ(String uri, String user, String password, Config config) {
    ...
    public static void main(String... args) {
        ...
        var uri = "neo4j+s://2be25d7b.databases.neo4j.io";


        var user = "neo4j";

        var password = "Ob45K7a1DfSQUFb6qI_WFh8edC_epUaAbGxkA7tb26Y";


        try (var app = new testyBZ(uri, user, password, Config.defaultConfig())) {
